...
public class SecurityHeadersFilter extends HttpFilter {
    ...
    protected void doFilter(HttpServletRequest req, HttpServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        if (req.getRequestURI().equals("/gamebanana/arbitrary-mod-app-settings")) {
            res.setHeader("Content-Security-Policy", "default-src 'self'; script-src 'self' https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net; frame-ancestors https://gamebanana.com; object-src 'none';");
            ...
            res.setHeader("Content-Security-Policy", "default-src 'self'; script-src 'self' https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net; frame-ancestors 'none'; object-src 'none';");
        }
