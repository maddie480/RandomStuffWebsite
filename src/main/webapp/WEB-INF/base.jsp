...
<html lang="en">
<head>
    <title><%= escapeHtml4((String) request.getAttribute("pageTitle")) %>
    </title>
    <meta charset="utf-8">
        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle <%= ((boolean) request.getAttribute("isCeleste")) ? "active" : "" %>"
                   href="#" id="celesteDropdown" role="button" data-bs-toggle="dropdown"
                   aria-expanded="false">Celeste</a>
                ...
                <ul class="dropdown-menu dropdown-menu-sm-end" aria-labelledby="celesteDropdown">
                    ...
                    <li>
                        <a class="dropdown-item <%= "celeste-news-network-subscription".equals(request.getAttribute("navId")) ? "active" : "" %>"
                           href="/celeste/news-network-subscription">#celeste_news_network Subscription</a></li>
                    <li>
                        <a class="dropdown-item <%= "collab-list".equals(request.getAttribute("navId")) ? "active" : "" %>"
                           href="/celeste/collab-contest-list">Collab & Contest List</a></li>
                    <li>
                        <a class="dropdown-item <%= "mod-catalog".equals(request.getAttribute("navId")) ? "active" : "" %>"
                           href="/celeste/custom-entity-catalog">Custom Entity Catalog</a></li>
                    <li>
                        <a class="dropdown-item <%= "direct-url-service".equals(request.getAttribute("navId")) ? "active" : "" %>"
                           href="/celeste/direct-link-service">Direct Link service</a></li>
                    <li>
                        <a class="dropdown-item <%= "everest-yaml-validator".equals(request.getAttribute("navId")) ? "active" : "" %>"
                    ...
                    <li>
                        <a class="dropdown-item <%= "font-generator".equals(request.getAttribute("navId")) ? "active" : "" %>"
                    ...
                    <li><a class="dropdown-item" href="/lua-cutscenes-documentation/index.html" target="_blank">Lua
                        Cutscenes Documentation</a></li>
                    <li><a class="dropdown-item" href="/celeste/map-tree-viewer">Map Tree Viewer</a></li>
                    <li>
                        <a class="dropdown-item <%= "mod-structure-verifier".equals(request.getAttribute("navId")) ? "active" : "" %>"
                           href="/celeste/mod-structure-verifier">Mod Structure Verifier</a></li>
                    <li>
                        <a class="dropdown-item <%= "olympus-news".equals(request.getAttribute("navId")) ? "active" : "" %>"
                           href="/celeste/olympus-news">Olympus News</a></li>
                    <li>
                        <a class="dropdown-item <%= "translation-viewer".equals(request.getAttribute("navId")) ? "active" : "" %>"
                           href="/celeste/translation-viewer">Translation Viewer</a></li>
                    <li>
                        <a class="dropdown-item <%= "update-checker-status".equals(request.getAttribute("navId")) ? "active" : "" %>"
            ...
            <li class="nav-item">
                <a class="nav-link <%= "discord-bots".equals(request.getAttribute("navId")) ? "active" : "" %>"
                   href="/discord-bots">Discord Bots</a>
            </li>
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="linksDropdown">
                    ...
                    <li><a class="dropdown-item" href="https://gamebanana.com/members/1698143" target="_blank">&#x1F34C;&nbsp;&nbsp;GameBanana
                        &#x2013; Celeste Mods</a></li>
                    <li><a class="dropdown-item" href="https://github.com/maddie480" target="_blank">&#x1F4BB;&nbsp;&nbsp;GitHub
                        &#x2013; Source Code</a></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>
                    <li><h6 class="dropdown-header">Les Navets Jouables (in French)</h6></li>
                    <li><a class="dropdown-item" href="https://github.com/maddie480/BazarLNJ" target="_blank">&#x1F50E;&nbsp;&nbsp;Bazar
                        LNJ &#x2013; Game Investigation</a></li>
                    <li>
                        <a class="dropdown-item <%= Arrays.asList("radio-lnj", "radio-lnj-playlist").contains(request.getAttribute("navId")) ? "active" : "" %>"
                    ...
                    <li>
                        <a class="dropdown-item <%= "quest-mods".equals(request.getAttribute("navId")) ? "active" : "" %>"
                           href="/quest/mods">&#x2694;&#xFE0F;&nbsp;&nbsp;Quest &#x2013; Game Mods</a></li>
                    <li>
                        <a class="dropdown-item <%= "quest-tools".equals(request.getAttribute("navId")) ? "active" : "" %>"
