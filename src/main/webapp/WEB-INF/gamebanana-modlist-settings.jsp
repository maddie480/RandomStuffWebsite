    ...
    <form method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="key" name="key" required
                   value="<%= escapeHtml4((String) request.getAttribute("typedKey")) %>">
            <p>
            ...
            <input type="text" class="form-control" id="keyfield" name="keyfield" disabled
                   value="<%= escapeHtml4((String) request.getAttribute("initialKey")) %>">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="title" name="title" required
                   value="<%= escapeHtml4((String) request.getAttribute("title")) %>">
        </div>

        <div class="form-group">
            <label for="modlist">Mod List (for example: <code>1337,5442</code> - don't put spaces!)</label>
            <input type="text" class="form-control" id="modlist" name="modlist" required pattern="([0-9]+,)*[0-9]+"
                   value="<%= escapeHtml4((String) request.getAttribute("modList")) %>">
        </div>
