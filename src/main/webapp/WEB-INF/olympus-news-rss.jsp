...
<%@ page
        import="java.util.List, ovh.maddie480.randomstuff.frontend.discord.newspublisher.OlympusNews, static org.apache.commons.text.StringEscapeUtils.escapeXml10, static org.apache.commons.text.StringEscapeUtils.escapeHtml4" %>

<feed xmlns="http://www.w3.org/2005/Atom" xml:lang="en">
    <title>Olympus News</title>
    <updated><%= ((List<OlympusNews>) request.getAttribute("news")).getFirst().slug().substring(0, 10) %>T00:00:00Z
    </updated>
