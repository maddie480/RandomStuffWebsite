<%@ page
        import="java.util.List, ovh.maddie480.randomstuff.frontend.quest.Mod, java.util.Arrays, static org.apache.commons.text.StringEscapeUtils.escapeHtml4" %>
...
<div class="row">
    ...
    <div class="col-lg-4 col-md-6 px-3 py-3">
        <div class="card">
            ...
            <% } %>
            <div class="card-body">
                <h5 class="card-title"><%= escapeHtml4(mod.getName()) %>
                </h5>
                ...
                <p class="card-text"><%= mod.getDescription() %>
                </p>
