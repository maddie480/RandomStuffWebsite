<%@ page
        import="java.util.Arrays, java.util.List, org.json.JSONObject, static org.apache.commons.text.StringEscapeUtils.escapeHtml4" %>
...
<div class="alert alert-info">
    To add your own, reach out to Maddie (maddie480 on the <a href="https://discord.gg/celeste" target="_blank">Mt.
    Celeste Climbing Association</a> server),
    ...
    <div class="accordion-item">
        <h2 class="accordion-header" id="heading-<%= id %>">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#collab-<%= id %>" aria-expanded="false" aria-controls="collab-<%= id %>">
        ...
        <div id="collab-<%= id %>" class="accordion-collapse collapse" aria-labelledby="heading-<%= id %>"
             data-bs-parent="#collab-list">
