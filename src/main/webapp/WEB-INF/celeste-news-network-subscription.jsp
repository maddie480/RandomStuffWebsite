...
<p>
    This page allows you to register a Discord webhook in order to have a copy of the <code>#celeste_news_network</code>
    channel from
...
<ul>
    ...
    <li>
        <b><a href="/celeste/olympus-news" target="_blank">Olympus News</a></b> &#x2013; Celeste modding news that
        appear in
        ...
        The news feed is managed by touhoe and cellularAutomaton (touhoe and cellularautomaton on Discord), and
        published through
        <a href="https://github.com/EverestAPI/EverestAPI.github.io/tree/main/olympusnews" target="_blank">the GitHub
            repository of the Everest website</a>.
    </li>
</ul>

<p>
    <b><%= request.getAttribute("sub_count") %> <%= ((int) request.getAttribute("sub_count")) == 1 ? "webhook" : "webhooks" %>
    </b> are currently registered.
</p>

<div class="alert alert-info">
    When registering your webhook, a message saying <i>"This webhook was registered on the #celeste_news_network
    subscription service!"</i> will be sent to it.
</div>
...
<form method="POST">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="url" name="url" required
               pattern="^https:\/\/discord\.com\/api\/webhooks\/[0-9]+/[A-Za-z0-9-_]+$">
    </div>
    <b>Subscribe to:</b>
    ...
    <p>
        <i>You can change your choices later by coming back to this page and subscribing again. This will update your
            subscription.</i>
    </p>
