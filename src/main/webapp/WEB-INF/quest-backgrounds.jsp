<%@ page
        import="java.util.List, ovh.maddie480.randomstuff.frontend.quest.Background, ovh.maddie480.randomstuff.frontend.quest.GameBackground, static org.apache.commons.text.StringEscapeUtils.escapeHtml4" %>
...
<div class="alert alert-primary" role="alert">
    <b><%= escapeHtml4((String) request.getAttribute("pseudo")) %>
    </b>, tu as <b><%= escapeHtml4((String) request.getAttribute("credit")) %>
</b>.
</div>
...
<div class="row">
    ...
    <div class="col-lg-4 col-md-6 px-3 py-3">
        <div class="card">
            ...
            <div class="card-body">
                <h5 class="card-title"><%= escapeHtml4(bg.nameUrlDecoded) %>
                </h5>
...
<p>
    ...
    Tu peux cliquer sur "Copier la commande" en-dessous d'un arrière-plan pour copier la commande correspondante dans le
    presse-papiers.
</p>
...
<div class="alert alert-info" role="alert">
    ...
    Il y en a d'autres, essaie d'utiliser la commande <code>!choose_game_bg [nom du jeu*]</code> pour en choisir
    un.<br/>
    <b>Note :</b> La plupart de ces arrière-plans sont fournis par Discord, tu trouveras donc presque uniquement des
    jeux PC.
</div>
...
<div class="row">
    ...
    <div class="col-lg-4 col-md-6 px-3 py-3">
        <div class="card">
            ...
            <div class="card-body">
                <h5 class="card-title"><%= escapeHtml4(bg.name) %>
                </h5>
