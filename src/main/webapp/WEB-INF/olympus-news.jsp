<%@ page
        import="java.util.List, java.time.LocalDate, java.time.format.DateTimeFormatter, java.time.format.FormatStyle, ovh.maddie480.randomstuff.frontend.discord.newspublisher.OlympusNews, static org.apache.commons.text.StringEscapeUtils.escapeHtml4" %>
...
<p>
    ...
    The news feed is managed by touhoe and cellularAutomaton (touhoe and cellularautomaton on Discord), and published
    through
...
<div class="row">
    ...
    <div class="col-xl-4 col-md-6 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <% if (news.title() != null) { %>
                <h5 class="card-title"><%= escapeHtml4(news.title()) %>
                </h5>
                <% } %>
                <p class="card-text">
                    <i>
                ...
                <button type="button" class="btn btn-secondary" data-bs-toggle="modal"
                        data-bs-target="#modal-<%= escapeHtml4(news.slug()) %>">
                    View more
                </button>

                <!-- Modal -->
                <div class="modal fade" id="modal-<%= escapeHtml4(news.slug()) %>" tabindex="-1"
                     aria-labelledby="#modal-label-<%= escapeHtml4(news.slug()) %>" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5"
                                    id="#modal-label-<%= escapeHtml4(news.slug()) %>"><%= escapeHtml4(news.title()) %>
                                </h1>
